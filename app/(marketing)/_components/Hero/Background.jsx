...
const Background = () => {
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      {/* Bottom-right Orbit */}
      <div className="absolute -bottom-25 -right-50 w-125 h-125 rounded-full bg-[radial-gradient(circle,rgba(6,182,212,0.1)_0%,transparent_70%)] animate-float2 -z-10"></div>

      {/* Orbit behind the Visual Hero */}
